...
<html>
<head>
    <title><fmt:message key="orderBy" bundle="${bundle}" /></title>
    <link rel="stylesheet" type="text/css" href="../../css/showGeneral.css">
</head>
<body>
<c:import url="../adminHeader.jsp" />
<c:if test="${requestScope.order.id ne 0}">
    <table>
        <tr>
            <th><fmt:message key="orderBy" bundle="${bundle}" /></th>
        </tr>
        <tr>
...
<c:if test="${requestScope.order.id eq 0}">
