...
<html>
  ...
  <body>
        ...
        <div class="menu-bar">
            <nav class="navigation">
                <ul class="list">
                    ...
                    <li class="item"><a class="header-link" href="#">Машины</a></li>
                    <li class="item"><a class="header-link" href="#">О нас</a></li>
                </ul>
            </nav>
        </div>
        <div class="login">
    ...
    <div class="main">
        ...
        <div class="about">
            <h2 class="about-title">Немного об аренде авто</h2>
        ...
        <div class="cars">
            <h1 class="cars-heading">Машины:</h1>
            <div class="car-info">
    ...
    <footer class="footer">
        ...
        <div class="copyright"><h5>Carsharing.Все права защищены!</h5></div>
    </footer>
  </body>
</html>
